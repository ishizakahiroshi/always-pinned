...
This extension does not make external network requests.

## Locally Stored Data

The extension stores settings in Chrome local storage. This includes enabled or disabled settings, per-window settings, and temporary tab IDs used to respect manual unpin actions.

This data stays inside the user's browser and is not transmitted externally.
